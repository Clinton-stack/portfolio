    ...
    <main>
      <div className='section-1' >
        <div className='nameText'>
          <Heading as='h1' size='4xl' color='#13315c' >Clinton Emenari</Heading>
          <Text fontSize='2xl' color='#13315c'>Software Developer</Text>
          <Text fontSize='l' color='##13315c' mt='10px'>&#34;I am an enthusiastic software developer driven by a passion for problem-solving through innovative software solutions.&#34;</Text>
      ...
      <div className='section-3'>
        <VStack maxW='900px' p='40px' spacing='20px'>
          ...
          <Heading as='h2' size='2xl' textAlign='center'>Experience</Heading>
          ...
          <HStack spacing='15px'>
            ...
            <Box width='100%'>
              ...
              <Text> Worked with WMS like Microsoft AX and Manhattan Scale to received, processed and tracked incoming and outgoing warehouse shipments. Troubleshot errors and maintained accuracy of scanners. Located and replenished missing items in stock.</Text>
            </Box>
          </HStack>
          ...
          <HStack spacing='15px'>
            ...
            <Box width='100%'>
              ...
              <Text>Developed front-end applications like an inventory management system using Angular. Learned the basics of Java with Spring-boot framework for developing back-end application</Text>
            </Box>
          </HStack>
          ...
          <HStack spacing='15px'>
            ...
            <Box width='100%'>
              ...
              <Text> Provided technical assistance over the phone or email. Conducted hardware maintenance, software troubleshooting, and installations. Developed a first aid website to address frequently asked software and hardware issues.</Text>
            </Box>
          </HStack>
